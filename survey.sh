...
if [ $SURVEY_UID = $SURVEY_UNAME ]; then
   echo "<li><font color=#red>FAIL: The Userid - $SURVEY_UID - appears to equal the Username - $SURVEY_UNAME - suggesting that it failed to resolve, please investigate and resolve.</font><br>" >> $x
